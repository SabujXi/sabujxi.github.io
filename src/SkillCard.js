...
function Skill({ name }) {
    return <div className="text-siteGreenDeeper bg-white text-2xl p-2 m-2 rounded-l-xl rounded-tr-full drop-shadow-[11px_7px_4px_rgba(0,0,0,0.25)] whitespace-nowrap hover:scale-105">
